...
import { ArchitectureNodePayload, ArchitectureEdgePayload } from '../types';

export const exportMarkdownDocs = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    nodes.forEach((n: ArchitectureNodePayload) => {
    ...
    nodes.forEach((n: ArchitectureNodePayload) => nodeMap.set(n.id, n.data.label || n.id));

    edges.forEach((e: ArchitectureEdgePayload) => {
...
export const exportTerraform = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    nodes.forEach((n: ArchitectureNodePayload, idx: number) => {
